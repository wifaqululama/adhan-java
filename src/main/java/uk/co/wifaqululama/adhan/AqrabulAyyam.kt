    ...
    fun getBritishAqrabulAyyamTime(date: DateComponents): LocalTime {
        ...
        if(latitude > 48.89){
            fajrAQ = when{
                ...
                latitude > 51.5 && latitude <= 51.75 -> 1.43
                latitude > 51.75 && latitude <= 52 -> 1.45
                latitude > 52 && latitude <= 52.25 -> 1.52
                latitude > 52.25 && latitude <= 52.5 -> 1.47
                latitude > 52.5 && latitude <= 52.75 -> 1.37
                latitude > 52.75 && latitude <= 53 -> 1.52
                latitude > 53 && latitude <= 53.25 -> 1.47
                latitude > 53.25 && latitude <= 53.5 -> 1.62
                latitude > 53.5 && latitude <= 53.75-> 1.57
                latitude > 53.75 && latitude <= 54 -> 1.6
